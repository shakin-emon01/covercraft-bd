...
exports.sendSessionAlertEmail = exports.sendPasswordResetEmail = exports.sendOTPEmail = exports.sendEmailVerificationCode = exports.sendWelcomeEmail = void 0;
 ...
 */
const sendSessionAlertEmail = async (to, name, deviceName, ipAddress) => {
    const mailOptions = {
        from: '"CoverCraft BD" <noreply@covercraftbd.com>',
        to,
...
exports.sendSessionAlertEmail = sendSessionAlertEmail;
